...
import { opTONTestnet, TONChainTestnet } from '@particle-network/chains';
...
const AccountAbstraction = () => {
  ...
  const smartAccount = new SmartAccount(provider, {
    ...
    aaOptions: {
      accountContracts: {
        SIMPLE: [{ chainIds: [TONChainTestnet.id], version: '1.0.0' }]
      }
    }
  });
      ...
      {!userInfo ? (
        ...
        <div className={styles.profilecard}>
          ...
          <div className={styles.balancesection}>
            <small className="text-green-400">{balance} TON</small>
