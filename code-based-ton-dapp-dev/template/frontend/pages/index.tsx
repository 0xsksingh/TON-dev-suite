...
const tabs = [
  ...
  { name: "Store on TON GreenField", component: <Storages /> },
  ...
  return (
    <div className="w-full mx-auto pr-8 pl-8 max-w-7xl relative pb-10 mt-32">
      ...
      <p className="text-xl text-muted-foreground">
        A comprehensive web3 dev stack for developers to quickly build Dapps on TON Blockchain including OPTON, BSC and TON GreenField.
      </p>
      ...
      <div className="flex flex-col  md:flex-row w-full">
        <div className="flex flex-col items-start justify-start w-full md:w-96 pr-8">
          ...
          <p className="leading-7 mt-2">
            Explore the features of TON Dev SDK below.
          </p>
