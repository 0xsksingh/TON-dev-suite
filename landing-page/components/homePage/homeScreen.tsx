                    ...
                    <div className="flex flex-col gap-12 px-12 py-8">
                        <div className="flex flex-col gap-8">
                            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                                Build DApps on TON with Ease
                            </h1>
                            <p className="max-w-[600px] text-muted-foreground md:text-xl">
                                Unleash the power of TON blockchain development with
                                our AI-powered no-code TON Dapp Builder. Empowering both coders and
                                non-coders to create cutting-edge DApps.
                            </p>
                        </div>
                        <div className="flex flex-col gap-2 min-[400px]:flex-row">
                            <Link
                                href="https://no-code-ton-dapp-builder-suite.vercel.app"
                                target="_blank"
